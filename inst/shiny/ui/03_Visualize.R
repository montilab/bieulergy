    ...
    tabPanel("Visualize Network",
      ...
      sidebarPanel(
        ...
        conditionalPanel(
          ...
          sliderInput("T3_node_size", label="Node Size", min=0, max=50, value=5, step=1, post=" px"),
          sliderInput("T3_edge_width", label="Edge Width", min=0, max=20, value=2, step=1, post=" px"), 
          sliderInput("T3_font_size", label="Font Size", min=0, max=25, value=4, step=1, post=" px"),
